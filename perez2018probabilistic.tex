...
\author{Sebasti\'an P\'erez Vasseur and Jos\'e L. Aznarte\fnref{myfootnote}}
\address{Artificial Intelligence Department\\Universidad Nacional de
  Educaci\'on a Distancia --- UNED\\c/ Juan del Rosal, 16, Madrid, Spain}
...
non parametric tests as described by Salvador et al. \cite{garcia_advanced_2010} . 
...
of each model. We see again the superior results of QGB against the other models.
It also shows how the area under curve 
