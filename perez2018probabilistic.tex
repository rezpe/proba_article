...
Also we are approximating the obtained percentiles to the percentiles of a lognorm function. 
This allows us to provide information to the algorythm on the expected shape of the distribution.

We found the best $k$ to be 250 after testing several values of $k$ and calculating 
